...
def test_genome_reader():
    extractor = emn.ExtractMutationNullomers("sample_data3/tiny_genome.fa", "sample_data3/tiny_genome_2nullomers.txt", nullomer_len=2)
...
def test_mutation_reader():
    extractor = emn.ExtractMutationNullomers("sample_data3/tiny_genome.fa", "sample_data3/tiny_genome_2nullomers.txt", nullomer_len=2)
    mutations = extractor._mutation_reader("sample_data3/tiny_genome_patient_variants.txt", comments="#")
...
def test_generate_left_flank():
    extractor = emn.ExtractMutationNullomers("sample_data3/tiny_genome.fa", "sample_data3/tiny_genome_3nullomers.txt", nullomer_len=3)
    mutations = extractor._mutation_reader("sample_data3/tiny_genome_patient_variants.txt", comments="#")
...
def test_nullomer_identification():
    extractor = emn.ExtractMutationNullomers("sample_data3/tiny_genome.fa", "sample_data3/tiny_genome_3nullomers.txt", nullomer_len=3)
    mutations = extractor.scan_mutations("sample_data3/tiny_genome_patient_variants.txt", chr_col=0, pos_col=1, ref_col=3, alt_col=4)
...
def test_variant_motif_range():
    extractor = emn.ExtractMutationNullomers("sample_data3/tiny_genome.fa", "sample_data3/tiny_genome_3nullomers.txt", nullomer_len=3)
    mutations = extractor.scan_mutations("sample_data3/tiny_genome_patient_variants.txt", chr_col=0, pos_col=1, ref_col=2, alt_col=3)
